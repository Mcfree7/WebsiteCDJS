...
<div class="pcoded-content">
        ...
        <li class="breadcrumb-item"><a href="{{route('home')}}">Membres</a> </li>
        </ul>
        </div>
        </div>
        </div>
...
<div class="col-sm-10">
    ...
    <form id="main" method="post" action="{{ route('membre.store') }}" novalidate enctype="multipart/form-data">
        @csrf
    <div class="form-group row">
    <label class="col-sm-2 col-form-label">Nom et Prénom(s)</label>
    <div class="col-sm-10">
    <input type="text" class="form-control" name="nom" id="nom" placeholder=" Nom et Prénom(s) " value="{{ old('nom') }}">
    @if ($errors->has('nom'))
    ...
    <div class="col-sm-10">
    <input type="text" class="form-control" name="poste" id="poste" placeholder=" Poste d'occupé " value="{{ old('poste') }}">
    @if ($errors->has('poste'))
        <span class="text-danger"> Champs obligatoire</span>
    @endif
    <span class="messages"></span>
